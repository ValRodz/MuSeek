...
$instructors = $pdo->prepare("
    SELECT i.InstructorID, i.Name, i.Profession as Specialty, i.Phone as Contact_Num, i.Email,
           GROUP_CONCAT(DISTINCT s.StudioName SEPARATOR ', ') as studios,
           COUNT(DISTINCT b.BookingID) as total_sessions
    FROM instructors i
    LEFT JOIN services srv ON i.InstructorID = srv.InstructorID
...
// Fetch studios for this owner (for the add instructor form)
$studios = $pdo->prepare("
    ...
    <div class="main-content">
        <div class="manage-instructors-container">
            ...
            <div class="page-header">
                ...
                <p class="page-subtitle">Add, edit, and manage instructors </p>
            </div>
