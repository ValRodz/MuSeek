...
<?php include __DIR__ . '/sidebar_netflix.php'; ?>
    ...
    <div id="addInstructorModal" class="modal">
        <div class="modal-content p-6">
            ...
            <form id="addInstructorForm" action="../../../add-instructor.php" method="post">
                <div class="space-y-4">
                    <div>
    ...
    <div id="editInstructorModal" class="modal">
        <div class="modal-content p-6">
            ...
            <form id="editInstructorForm" action="../../../update-instructor.php" method="post">
    ...
    <div id="confirmRemoveModal" class="modal">
        <div class="modal-content p-6">
            ...
            <form id="removeInstructorForm" action="../../../remove-instructor.php" method="post">
    ...
    <script>
        // Sidebar is managed by sidebar_netflix.php; legacy toggle code removed.
