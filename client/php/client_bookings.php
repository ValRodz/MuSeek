                                        ...
                                        <td class="action-buttons">
                                            ...
                                            <?php elseif (!empty($booking['Book_StatsID']) && (int)$booking['Book_StatsID'] === 1): ?>
                                                ...
                                                <?php elseif (!empty($booking['Pay_Stats']) && strtolower($booking['Pay_Stats']) === 'pending'): ?>
                                                    <a class="update-button" href="view_status.php?booking_id=<?php echo $booking['BookingID']; ?>&studio_id=<?php echo $booking['StudioID']; ?>&owner_id=<?php echo $booking['OwnerID']; ?>" onclick="event.stopPropagation();">View Status</a>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
        ...
        function showBookingModal(booking) {
            ...
            if (booking.status === 'Pending') {
                ...
                if (booking.Pay_Stats && (booking.Pay_Stats === 'Confirmed' || booking.Pay_Stats === 'Completed')) {
                    ...
                    modalElements.modalButtons.innerHTML = `
                        <button class="update-button" onclick="goToViewStatus(${booking.BookingID}, ${booking.StudioID}, ${booking.OwnerID});">View Status</button>
