...
if ($partner_id === 0) {
    ...
    if ($res && $row = $res->fetch_assoc()) {
        ...
        // No prior conversations: fall back to the chat list
...
<head>
    ...
    <title>Chat • <?php echo $studio ? htmlspecialchars($studio['StudioName']) . ' • ' : ''; ?><?php echo htmlspecialchars($partner['name']); ?></title>
